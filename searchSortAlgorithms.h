...
template <class elemType>
void bubbleSort2(elemType list[], int length, int& comp, int& assign)
{
    elemType temp;
    int iteration;
    int index;
...
template <class elemType>
void selectionSort2(elemType list[], int length, int& comp, int& assign)
{
    int index;
    int smallestIndex;
    int minIndex;
    ...
    {
        minLocation(list, index, length - 1, smallestIndex, comp);
...
template <class elemType>
void minLocation(elemType list[], int first, int last, int& smallestIndex, int& comp)
{
    int loc;
...
template <class elemType>
void insertionSort2(elemType list[], int listLength, int& comp, int& assign)
{
